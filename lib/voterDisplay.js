...
export function getVoterId(voter) {
  return voter.elector_id || voter.electorId || voter.voterId || voter["EPIC No."] || "";
}
...
export function getVoterWard(voter) {
  return voter.ward || voter.voterWardNo || voter.house_no || voter.houseNo || voter.house_number || "";
}
