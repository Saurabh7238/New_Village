...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <head></head>
<body className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-yellow-50 text-gray-900 font-sans relative dark:bg-gradient-to-br dark:from-gray-950 dark:via-gray-900 dark:to-emerald-950 dark:text-gray-100">
        <Providers>
          <noscript>
