...
export default function DashboardPage() {
  ...
  const serviceCards = [
    ...services.map(([serviceType, title]) => ({ title, href: `/dashboard/applications?service=${serviceType}`, count: byService[serviceType] || 0 })),
    { title: 'My Queries', href: '/track', count: byRelatedType.query || 0 },
    { title: 'My Appointments', href: '/appointments', count: byRelatedType.appointment || 0 },
  ];
